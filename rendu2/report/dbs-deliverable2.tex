...
their descriptive data (Recording, Release) and their physical incarnation (Track, Medium). 
Since data is often incomplete, most of the entities 'can be related'.
