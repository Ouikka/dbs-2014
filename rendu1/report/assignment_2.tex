...
\chead{\hmwkClassShort\ (\hmwkClassInstructor): \hmwkTitle} % Top center head
...
\newcommand{\hmwkClassInstructor}{Ailamaki} % Teacher/lecturer
...
\lstinputlisting[language=SQL]{script_example.sql}{Sample SQL Script With Highlighting}
\lipsum[1]
\end{homeworkProblem}
...
\problemAnswer{
\begin{center}
\includegraphics[width=0.75\columnwidth]{area} % Example image
\end{center}
